...
plugin.init = async (params) => {
	...
	const settings = await meta.settings.get('azure-openai')
	...
	routeHelpers.setupAdminPageRoute(router, '/admin/plugins/azure-openai', controllers.renderAdminPage);
};
